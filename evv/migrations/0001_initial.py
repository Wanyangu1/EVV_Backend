# Generated by Django 5.2 on 2025-12-01 23:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['last_name', 'first_name'],
                'indexes': [models.Index(fields=['last_name', 'first_name'], name='evv_employe_last_na_3d8f5c_idx'), models.Index(fields=['status'], name='evv_employe_status_e73c96_idx'), models.Index(fields=['evv_status'], name='evv_employe_evv_sta_de79ac_idx')],
            },
        ),
        migrations.CreateModel(
            name='Claim',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours_to_bill', models.DecimalField(decimal_places=3, default=0.0, max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(99.999)])),
                ('hours_to_pay', models.DecimalField(decimal_places=3, default=0.0, max_digits=5, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(99.999)])),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['client', 'schedule_start_time'], name='evv_visits_client__94a9dd_idx'), models.Index(fields=['employee', 'schedule_start_time'], name='evv_visits_employe_55c8cc_idx'), models.Index(fields=['visit_type'], name='evv_visits_visit_t_5502cb_idx'), models.Index(fields=['submitted_to_evv'], name='evv_visits_submitt_15cfbc_idx'), models.Index(fields=['visit_other_id'], name='evv_visits_visit_o_a26311_idx')],
            },
        ),
    ]
